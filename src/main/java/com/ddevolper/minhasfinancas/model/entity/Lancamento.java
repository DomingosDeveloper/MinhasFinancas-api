...
public class Lancamento {
	...
	@Override
	public int hashCode() {
		return Objects.hash(ano, data, descricao, id, mes, status, tipo, usuario, valor);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(ano, other.ano) && Objects.equals(data, other.data)
	...
	public String toString() {
		return "Lancamento [id=" + id + ", descricao=" + descricao + ", mes=" + mes + ", ano=" + ano + ", usuario="
				+ usuario + ", valor=" + valor + ", data=" + data + ", tipo=" + tipo + ", status=" + status + "]";
	}
